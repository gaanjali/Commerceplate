    ...
    <>
      ...
      <div className="bg-gray-50 min-h-screen">
        ...
        <div className="container mt-12 mx-auto px-6 lg:px-20">
          {/* Who We Are Section */}
          <section className="flex flex-col lg:flex-row items-center lg:items-start gap-12 mb-20">
            ...
            <div className="lg:w-1/2">
              <div className="relative w-full h-96 lg:h-96">
                <Image
                  src="/images/lamp 4.jpg" // Replace with your image path in the public folder
                  alt="Who We Are"
          ...
          <section className="mb-20">
            <h2 className="text-3xl mt-12 font-bold text-gray-800 mb-4">Our Company</h2>
          ...
          {/* Staff Section */}
          <section className="mb-20">
            <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Our Staff</h2>
